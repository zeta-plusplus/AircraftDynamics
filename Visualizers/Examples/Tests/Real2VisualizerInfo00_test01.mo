...
model Real2VisualizerInfo00_test01
  ...
  AircraftDynamics.Interfaces.Real2VisualizerInfo00 Real2VisInfo(use_u_alt = false, use_u_phi = true, use_u_psi = true, use_u_theta = true, use_u_xEast = false, use_u_xNorth = false)  annotation(
...
equation
  ...
  connect(Real2VisInfo.u_phi, from_deg1.y) annotation(
    Line(points = {{-5, 17}, {-12, 17}, {-12, 30}, {-28, 30}}, color = {0, 0, 127}));
  connect(from_deg3.y, Real2VisInfo.u_psi) annotation(
    Line(points = {{-28, -30}, {-12, -30}, {-12, 4}, {-5, 4}}, color = {0, 0, 127}));
  connect(from_deg2.y, Real2VisInfo.u_theta) annotation(
    Line(points = {{-28, 0}, {-16, 0}, {-16, 11}, {-5, 11}}, color = {0, 0, 127}));
