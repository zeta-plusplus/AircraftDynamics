...
model visAtt_DoF3_AircraftMassCenter_ex01
  ...
  Modelica.Blocks.Sources.Constant const_bank(k = 40) annotation(
...
equation
  connect(aircraftMassCenter1.VisInfoOut, AnimAircraft.VisInfoIn) annotation(
    Line(points = {{94, -40}, {94, -40}, {94, 50}, {100, 50}, {100, 50}}, color = {95, 95, 95}));
  connect(gain1.y, aircraftMassCenter1.InfoBus1.alphaCmd) annotation(
    Line(points = {{-49, -140}, {46, -140}, {46, -100}}, color = {255, 170, 0}));
  connect(gain2.y, aircraftMassCenter1.InfoBus1.phi) annotation(
    Line(points = {{-49, -180}, {46, -180}, {46, -100}}, color = {255, 170, 0}));
  ...
  connect(gain2.u, const_bank.y) annotation(
...
end visAtt_DoF3_AircraftMassCenter_ex01;
