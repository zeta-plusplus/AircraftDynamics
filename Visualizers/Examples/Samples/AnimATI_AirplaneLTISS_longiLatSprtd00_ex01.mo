...
model AnimATI_AirplaneLTISS_longiLatSprtd00_ex01
  ...
  AircraftDynamics.RigidBodyFDM.Components.AirplaneLTISS_longiLatSprtd00 AirplaneDyn(redeclare package Medium = AircraftDynamics.Media.DryAirMethaneMixture00) annotation(
...
end AnimATI_AirplaneLTISS_longiLatSprtd00_ex01;
