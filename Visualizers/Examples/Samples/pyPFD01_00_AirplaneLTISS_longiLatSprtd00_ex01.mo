...
model pyPFD01_00_AirplaneLTISS_longiLatSprtd00_ex01
  ...
  interactive_pyPFD01_00 pyPFD(tInterval = 0.02) annotation(
    Placement(visible = true, transformation(origin = {90, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(AirplaneDyn.VisInfoOut, pyPFD.VisInfoIn) annotation(
    Line(points = {{56, 20}, {56, 50}, {80, 50}}, color = {95, 95, 95}));
  annotation(
...
end pyPFD01_00_AirplaneLTISS_longiLatSprtd00_ex01;
