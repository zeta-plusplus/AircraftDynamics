...
model testAircraft003
  ...
  AircraftDynamics.PtMassFDM.DoF2.Examples.tests.testAircraft003.eng eng1 annotation(
...
equation
  connect(ramp_dm_fuel.y, eng1.u_dm_fuel) annotation(
    Line(points = {{-79, -70}, {-70.5, -70}, {-70.5, -92}, {-62, -92}}, color = {0, 0, 127}));
  connect(gain2.y, aircraftMassCenter1.u_FxForward[1]) annotation(
    Line(points = {{22, -100}, {36, -100}, {36, -10}, {46, -10}, {46, -10}}, color = {0, 0, 127}));
  connect(eng1.y_Fn, gain2.u) annotation(
