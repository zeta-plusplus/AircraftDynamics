...
connector VisualizerInfoOut00
  ...
  output Units.Angle att[3] "attitude angles; roll, pitch, yaw";
  
  
annotation (defaultComponentName="VisInfoOut",
   Icon(coordinateSystem(
        initialScale = 0.16), graphics={Rectangle(lineColor = {95, 95, 95}, lineThickness = 0.5, extent = {{-10, 10}, {10, -10}}), Rectangle(fillColor = {144, 144, 144}, fillPattern = FillPattern.Solid, extent = {{-30, 100}, {30, -100}})}),
