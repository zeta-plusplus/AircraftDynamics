...
model RigidBody6DoF_DzhanibekovTheorem_rot_p_ex01
  extends Modelica.Icons.Example;
  inner AircraftDynamics.SimEnvironment environmentAircraftDynSim annotation(
    Placement(visible = true, transformation(origin = {-70, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  AircraftDynamics.RigidBodyFDM.Components.Aircraft_RigidBody6DoF00 airplaneDyn(Ixx_par = 100, Iyy_par = 1000, Izz_par = 10000,nSrcForceMoment = 0,p_init_par = 1 * Modelica.Constants.pi, phi_init_par(displayUnit = "deg"), q(fixed = true), q_init_par = 0.001 * Modelica.Constants.pi, r_init_par = 0.001 * Modelica.Constants.pi, theta_init_par(displayUnit = "rad") = 0) annotation(
...
end RigidBody6DoF_DzhanibekovTheorem_rot_p_ex01;
