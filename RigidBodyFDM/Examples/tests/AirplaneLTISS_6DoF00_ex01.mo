...
equation
  connect(from_deg3.y, AirplaneDyn.u_deltaR) annotation(
    Line(points = {{22, -50}, {50, -50}, {50, -8}, {58, -8}, {58, -8}}, color = {0, 0, 127}));
  connect(limiter_deltaA.y, AirplaneDyn.u_deltaA) annotation(
    Line(points = {{12, -10}, {30, -10}, {30, 2}, {58, 2}, {58, 4}}, color = {0, 0, 127}));
  connect(gain_Tnominal.y, AirplaneDyn.u_deltaT) annotation(
    Line(points = {{22, 30}, {38, 30}, {38, 22}, {58, 22}, {58, 22}}, color = {0, 0, 127}));
  connect(from_deg1.y, AirplaneDyn.u_deltaE) annotation(
    Line(points = {{22, 70}, {48, 70}, {48, 34}, {58, 34}, {58, 34}}, color = {0, 0, 127}));
  connect(AirplaneDyn.FltStatesBus1, sensorPhi.FltStatesBus1) annotation(
    Line(points = {{120, -14}, {120, -14}, {120, -80}, {120, -80}}, color = {255, 204, 51}, thickness = 0.5));
