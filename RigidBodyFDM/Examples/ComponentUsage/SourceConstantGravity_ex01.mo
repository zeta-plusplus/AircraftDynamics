...
model SourceConstantGravity_ex01
  ...
  AircraftDynamics.RigidBodyFDM.Components.Aircraft_RigidBody6DoF00 airplaneDyn( p_init_par = 0 * Modelica.Constants.pi / 180, phi_init_par(displayUnit = "rad"), q(fixed = true), q_init_par = 500 * Modelica.Constants.pi / 180, r_init_par = 0 * Modelica.Constants.pi / 180) annotation(
