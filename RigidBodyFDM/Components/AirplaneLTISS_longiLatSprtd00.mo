...
model AirplaneLTISS_longiLatSprtd00
  ...
  Modelica.Blocks.Interfaces.RealInput u_deltaA annotation(
    Placement(visible = true, transformation(origin = {-140, -20}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-190, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput u_deltaR annotation(
    Placement(visible = true, transformation(origin = {-140, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-190, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  AircraftDynamics.Interfaces.FlightStatesBus FltStatesBus1 annotation(
    Placement(visible = true, transformation(origin = {120, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {180, -140}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //**********************************************************************
...
//-----
  ...
  VisInfoOut.theta[1] = fltAng4disp.phi;
  VisInfoOut.theta[2] = fltAng4disp.theta;
  VisInfoOut.theta[3] = fltAng4disp.psi;
  VisInfoOut.alpha = fltAng4disp.alpha;
  VisInfoOut.beta= fltAng4disp.beta;
//-----
...
//----------
  annotation(
    ...
    Icon(graphics = {Text(origin = {2, -192}, extent = {{-182, 8}, {178, -8}}, textString = "%name")}, coordinateSystem(initialScale = 0.1, extent = {{-180, -180}, {180, 180}})),
