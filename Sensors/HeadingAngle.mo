...
model HeadingAngle
  ...
  ********************************************************/
  /* ---------------------------------------------
            Interface
  --------------------------------------------- */
  output Modelica.Blocks.Interfaces.RealOutput y_psi(final quantity = "Angle", final unit="rad", displayUnit="rad") "Heading Angle" annotation(
...
/* ---------------------------------------------
              Interface
  --------------------------------------------- */
  connect(FltStatesBus1.fltAng4disp.psi, y_psi);
